...
>
> 📑 **Task :** A function that fills memory with a constant byte.
>
> 📝 **Required :** 
...
>
> 📑 **Task :** A function that copies memory area.
>
> 📝 **Required :** 
...
>
> 📑 **Task :** A function that locates a character in a string.
>
> 📝 **Required :** Returns a pointer to the first occurrence of the character c in the string s, or NULL if the character is not found.
<br>
...
>
> 📑 **Task :** A function that gets the length of a prefix substring.
>
> 📝 **Required :** Returns the number of bytes in the initial segment of s which consist only of bytes from accept.
<br>
...
>
> 📑 **Task :** A function that searches a string for any of a set of bytes.
>
> 📝 **Required :** 
...
>
> 📑 **Task :** A function that locates a substring.
>
> 📝 **Required :** 
...
>
> 📑 **Task :** A function that prints the chessboard.
>
...
>
> 📑 **Task :** A function that prints the sum of the two diagonals of a square matrix of integers.
>
> 📝 **Required :** 
...
>
> 📑 **Task :** A function that sets the value of a pointer to a char.
<br>
...
>
> 📑 **Task :** A file that contains the password for the crackme2 executable.
>
> 📝 **Required :** Your file should contain the exact password, no new line, no extra space.
>
> 💬 *Quote : Kevin Mitnick: My primary goal of hacking was the intellectual curiosity, the seduction of adventure.*
