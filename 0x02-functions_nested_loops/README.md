...
> 
> 📑 **Task :** A program that prints _putchar, followed by a new line.
> 
> 📝 **Required :**  The program should return 0
<br>
...
> 
> 📑 **Task :** A function that prints the alphabet, in lowercase, followed by a new line.
> 
...
> 
> 📑 **Task :** A function that prints 10 times the alphabet, in lowercase, followed by a new line.
> 
> 📝 **Required :** You can only use _putchar twice in your code    
<br>
...
> 
> 📑 **Task :** A function that checks for lowercase character.
> 
> 📝 **Required :**  Returns 1 if c is lowercase. Returns 0 otherwise
<br>
...
> 
> 📑 **Task :** A function that checks for alphabetic character.
> 
> 📝 **Required :** 
...
> 
> 📑 **Task :** A function that prints the sign of a number.
> 
> 📝 **Required :** 
...
> 
> 📑 **Task :** A function that computes the absolute value of an integer.
>     
...
> 
> 📑 **Task :** A function that prints the last digit of a number.
> 
> 📝 **Required :**  Returns the value of the last digit.
>     
...
> 
> 📑 **Task :** A function that prints every minute of the day of Jack Bauer, starting from 00:00 to 23:59.
>     
...
> 
> 📑 **Task :** A function that prints the 9 times table, starting with 0. 
<br>
...
> 
> 📑 **Task :** A function that adds two integers and returns the result. 
>    
<br>
...
> 
> 📑 **Task :** A function that prints the n times table, starting with 0.
> 
...
> 
> 📑 **Task :** A program that computes and prints the sum of all the multiples of 3 or 5 below 1024 (excluded), followed by a new line.
>       
...
> 
> 📑 **Task :** A program that prints the first 50 Fibonacci numbers, starting with 1 and 2, followed by a new line.
> 
> 📝 **Required :** If n is greater than 15 or less than 0 the function should not print anything.
...
> 
> 📑 **Task :** A program that finds and prints the sum of the even-valued terms, followed by a new line.
>        
